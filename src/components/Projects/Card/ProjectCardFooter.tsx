...
//             <a href={demoLink} target="_blank" rel="noopener noreferrer" className="shadowed project-card__button">
...
//                 Live Demo
//             </a>
//             <a href={githubLink} target="_blank" rel="noopener noreferrer" className="shadowed project-card__button">
